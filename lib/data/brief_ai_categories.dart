...
class BriefAiCategories {
  ...
  static const List<CategoryDefinition> all = [
    ...
    CategoryDefinition(
      id: 'kaution_vereinbarung',
      labelKey: 'cat_kaution_vereinbarung_label',
      summaryKey: 'cat_kaution_vereinbarung_summary',
      mainCategory: MainCategory.categoryRent,
      decisiveKeywords: [
      ...
      supportingKeywords: ['Mieter', 'Vermieter', 'Mietvertrag', 'Kaution'],
      negativeKeywords: [
        'Kautionsabrechnung',
        'Kautionsrückzahlung',
        'Einbehalt',
      ...
      nextStepKeys: [
        'cat_kaution_vereinbarung_step1',
        'cat_kaution_vereinbarung_step2',
        'cat_kaution_vereinbarung_step3',
        'cat_kaution_vereinbarung_step4',
        'cat_kaution_vereinbarung_step5',
      ],
      riskLevel: RiskLevel.low,
    ),
    CategoryDefinition(
      id: 'kaution_zahlung_bestaetigung',
      labelKey: 'cat_kaution_zahlung_bestaetigung_label',
      summaryKey: 'cat_kaution_zahlung_bestaetigung_summary',
      mainCategory: MainCategory.categoryRent,
      decisiveKeywords: [
        'Bestätigung der Kautionszahlung',
        'Kautionszahlung erhalten',
        'Zahlungseingang Kaution',
      ],
      supportingKeywords: ['Mieter', 'Vermieter', 'Kaution', 'Bestätigung'],
      negativeKeywords: [
        'Kautionsabrechnung',
        'Kautionsrückzahlung',
        'Einbehalt',
      ...
      nextStepKeys: [
        'cat_kaution_zahlung_bestaetigung_step1',
        'cat_kaution_zahlung_bestaetigung_step2',
        'cat_kaution_zahlung_bestaetigung_step3',
        'cat_kaution_zahlung_bestaetigung_step4',
        'cat_kaution_zahlung_bestaetigung_step5',
      ],
      riskLevel: RiskLevel.low,
    ),
    CategoryDefinition(
      ...
      decisiveKeywords: [
        'Kautionsabrechnung',
        'Abrechnung Kaution',
        'Kautionsbetrag Abrechnung',
      ],
      supportingKeywords: ['Mieter', 'Vermieter', 'Abzüge', 'Schäden'],
      negativeKeywords: ['Kautionsvereinbarung', 'Bestätigung Zahlung'],
      nextStepKeys: [
    ...
    CategoryDefinition(
      id: 'kaution_einbehalt',
      labelKey: 'cat_kaution_einbehalt_label',
      summaryKey: 'cat_kaution_einbehalt_summary',
      mainCategory: MainCategory.categoryRent,
      decisiveKeywords: [
      ...
      supportingKeywords: ['Mieter', 'Vermieter', 'Schäden', 'Abzüge'],
      negativeKeywords: [
        'Kautionsvereinbarung',
        'Bestätigung Zahlung',
        'Rückzahlung',
      ...
      nextStepKeys: [
        'cat_kaution_einbehalt_step1',
        'cat_kaution_einbehalt_step2',
        'cat_kaution_einbehalt_step3',
        'cat_kaution_einbehalt_step4',
        'cat_kaution_einbehalt_step5',
      ],
      riskLevel: RiskLevel.medium,
    ),
    CategoryDefinition(
